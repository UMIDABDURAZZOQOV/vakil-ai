...
const T: Record<Lang, Dict> = {
  uz: {
    ...
    // tools (templates / legal / compare)
    tools: "Vositalar",
    tools_templates: "Hujjat yaratish", tools_templates_desc: "Savol-javobdan tayyor shartnoma",
    tools_legal: "Yuridik savol", tools_legal_desc: "Istalgan huquqiy savolga javob",
    tools_compare: "Hujjatlarni solishtirish", tools_compare_desc: "Ikki versiyadagi farqlar",
    tpl_title: "Hujjat yaratish", tpl_sub: "Bir necha savolga javob bering — Vakil AI tayyor hujjat yasaydi.",
    tpl_choose: "Hujjat turini tanlang", tpl_nda: "Maxfiylik shartnomasi (NDA)", tpl_rental: "Ijara shartnomasi", tpl_freelance: "Frilans shartnoma",
    tpl_partyA: "Birinchi tomon (ism/tashkilot)", tpl_partyB: "Ikkinchi tomon (ism/tashkilot)",
    tpl_subject: "Mavzu / predmet", tpl_amount: "Summa / narx", tpl_date: "Sana / muddat", tpl_extra: "Qo'shimcha shartlar (ixtiyoriy)",
    tpl_generate: "Yaratish", tpl_generating: "Yaratilyapti…", tpl_result: "Tayyor hujjat",
    copy: "Nusxa olish", copied: "Nusxa olindi", download: "Yuklab olish",
    legal_title: "Yuridik savol", legal_sub: "Istalgan huquqiy savolni bering — Vakil AI oddiy tilda tushuntiradi.",
    legal_ph: "Savolingizni yozing… masalan: YATT qanday ochiladi?", legal_ask: "So'rash", legal_asking: "Javob tayyorlanyapti…",
    legal_examples: "Namuna savollar", legal_ex1: "YATT qanday ochiladi?", legal_ex2: "Ishdan bo'shatishda qanday huquqlarim bor?", legal_ex3: "Ijara shartnomasida nimaga e'tibor berish kerak?",
    legal_disclaimer: "Vakil AI umumiy ma'lumot beradi, professional yurist o'rnini bosmaydi.",
    cmp_title: "Hujjatlarni solishtirish", cmp_sub: "Ikki versiyani joylashtiring — Vakil AI nima o'zgarganini ko'rsatadi.",
  ...
  ru: {
    ...
    tools: "Инструменты",
    tools_templates: "Создать документ", tools_templates_desc: "Готовый договор по анкете",
    tools_legal: "Юридический вопрос", tools_legal_desc: "Ответ на любой правовой вопрос",
    tools_compare: "Сравнить документы", tools_compare_desc: "Различия двух версий",
    tpl_title: "Создать документ", tpl_sub: "Ответьте на несколько вопросов — Vakil AI составит готовый документ.",
    tpl_choose: "Выберите тип документа", tpl_nda: "Соглашение о неразглашении (NDA)", tpl_rental: "Договор аренды", tpl_freelance: "Договор фриланса",
    tpl_partyA: "Первая сторона (имя/организация)", tpl_partyB: "Вторая сторона (имя/организация)",
    tpl_subject: "Предмет / тема", tpl_amount: "Сумма / цена", tpl_date: "Дата / срок", tpl_extra: "Доп. условия (необязательно)",
    tpl_generate: "Создать", tpl_generating: "Создаётся…", tpl_result: "Готовый документ",
    copy: "Копировать", copied: "Скопировано", download: "Скачать",
    legal_title: "Юридический вопрос", legal_sub: "Задайте любой правовой вопрос — Vakil AI объяснит простым языком.",
    legal_ph: "Напишите вопрос… например: как открыть ЯТТ?", legal_ask: "Спросить", legal_asking: "Готовим ответ…",
    legal_examples: "Примеры вопросов", legal_ex1: "Как открыть ЯТТ (ИП)?", legal_ex2: "Какие у меня права при увольнении?", legal_ex3: "На что обратить внимание в договоре аренды?",
    legal_disclaimer: "Vakil AI даёт общую информацию и не заменяет профессионального юриста.",
    cmp_title: "Сравнить документы", cmp_sub: "Вставьте две версии — Vakil AI покажет, что изменилось.",
  ...
  en: {
    ...
    tools: "Tools",
    tools_templates: "Create a document", tools_templates_desc: "A ready contract from a short form",
    tools_legal: "Legal question", tools_legal_desc: "An answer to any legal question",
    tools_compare: "Compare documents", tools_compare_desc: "The differences between two versions",
    tpl_title: "Create a document", tpl_sub: "Answer a few questions — Vakil AI drafts a ready document.",
    tpl_choose: "Choose a document type", tpl_nda: "Non-disclosure agreement (NDA)", tpl_rental: "Rental agreement", tpl_freelance: "Freelance contract",
    tpl_partyA: "First party (name/company)", tpl_partyB: "Second party (name/company)",
    tpl_subject: "Subject / matter", tpl_amount: "Amount / price", tpl_date: "Date / term", tpl_extra: "Extra terms (optional)",
    tpl_generate: "Generate", tpl_generating: "Generating…", tpl_result: "Ready document",
    copy: "Copy", copied: "Copied", download: "Download",
    legal_title: "Legal question", legal_sub: "Ask any legal question — Vakil AI explains in plain language.",
    legal_ph: "Type your question… e.g. how do I register as self-employed?", legal_ask: "Ask", legal_asking: "Preparing an answer…",
    legal_examples: "Example questions", legal_ex1: "How do I register as a sole trader (YATT)?", legal_ex2: "What are my rights if I'm dismissed?", legal_ex3: "What should I watch for in a rental agreement?",
    legal_disclaimer: "Vakil AI provides general information and is not a substitute for a professional lawyer.",
    cmp_title: "Compare documents", cmp_sub: "Paste two versions — Vakil AI shows what changed.",
